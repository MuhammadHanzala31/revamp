  ...
  return (
    <div className='bg-[#4848481C] p-8 rounded-3xl flex flex-col gap-6 w-[90%] mx-auto'>
        ...
        <div className='relative'>
            ...
            <textarea  className='bg-white w-full rounded-xl py-3 outline-none px-3 pl-10 placeholder:text-lg placeholder:text-[#404040] placeholder:font-normal placeholder:font-neue-montreal text-lg text-[#404040] resize-none h-[17.014vw]' placeholder='Enter your Message' />
        </div>
