    ...
    return (
        <section className='flex lg:flex-row justify-between flex-col px-16 my-20'>
            <div className='flex flex-col gap-4 lg:w-[40%] w-full'>
                <Badge text='FAQ’s' />
                <h3 className='text-white font-aeonik text-[3.333vw] font-medium leading-[50px]'>
            ...
            <div className='lg:w-[60%] w-full flex flex-col gap-6'>
                <Accordion/>
                <div className='flex flex-row bg-[#FFFFFF0A] rounded-[14px] py-2 px-6 justify-between w-full items-center'>
                    ...
                    <button className='bg-[#7C1874]  transition-all w-fit duration-300 cursor-pointer hover:scale-[1.1] border border-[#7C1874] shadow-md shadow-[#7C1874] rounded-full text-[#F3F3F3] font-neue-montreal font-[400] text-[16px] hover:opacity-90 px-[18px] py-[10px] flex items-center gap-2'>
