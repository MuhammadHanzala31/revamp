    ...
    return (
        <section className='px-16 my-[5.556vw]'>
            ...
            <div className='flex flex-row gap-16 mt-16 justify-center items-center'>
                ...
                <span className='w-[1px] h-[5.764vw] bg-white'></span>
                <div className='flex flex-col gap-3.5'>
            ...
            <div className='flex flex-row gap-4 items-center mt-32 '>
                <div className='flex flex-col gap-4 lg:w-[30%]'>
                    <div className="flex flex-col gap-1">
                        ...
                        <p className="text-[1.111vw] text-[#CFCFCF] font-normal font-neue-montreal leading-relaxed">We do not chase vanity metrics like impressions or likes. Every decision is made with ROI, conversions, and business growth in mind.</p>
                    </div>
                    <div className="flex flex-col gap-1">
                        ...
                        <p className="text-[1.111vw] text-[#CFCFCF] font-normal font-neue-montreal leading-relaxed">Your business is not a template, and your marketing should not be either. We design solutions tailored to your goals, industry, and audience.</p>
                    </div>
                    <div className="flex flex-col gap-1">
                        <span className="text-xl text-white font-medium font-neue-montreal tracking-widest uppercase">AI-Based execution</span>
                        <p className="text-[1.111vw] text-[#CFCFCF] font-normal font-neue-montreal leading-relaxed">We use AI to work smarter, personalize better, and move faster, so your business stays ahead in a market where automation and intelligence are becoming standard.</p>
                    </div>
                    <div className="flex flex-col gap-1">
                        <span className="text-xl text-white font-medium font-neue-montreal tracking-widest uppercase">Systems that scale</span>
                        <p className="text-[1.111vw] text-[#CFCFCF] font-normal font-neue-montreal leading-relaxed">We build marketing systems that grow with you, so you are not starting over every time you expand.</p>
                    </div>
                </div>
                ...
                <div className='flex flex-col gap-4 lg:w-[30%]'>
                    <div className="flex flex-col gap-1">
                        ...
                        <p className="text-[1.111vw] text-[#CFCFCF] font-normal font-neue-montreal leading-relaxed">We move quickly, execute efficiently, and keep momentum high, helping you beat slower competitors.</p>
                    </div>
                    <div className="flex flex-col gap-1">
                        <span className="text-xl text-white font-medium font-neue-montreal tracking-widest uppercase">Data-Led decisions</span>
                        <p className="text-[1.111vw] text-[#CFCFCF] font-normal font-neue-montreal leading-relaxed">We track what matters, analyze performance closely, and optimize continuously to improve results over time.</p>
                    </div>
                    <div className="flex flex-col gap-1">
                        ...
                        <p className="text-[1.111vw] text-[#CFCFCF] font-normal font-neue-montreal leading-relaxed">Our strategies are designed for high-competition environments, where attention is expensive and only performance-driven execution wins.</p>
                    </div>
