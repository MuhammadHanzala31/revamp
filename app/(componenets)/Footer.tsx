        ...
        <footer className='relative  px-16 mt-55'>
            ...
            <div className="grid lg:grid-cols-4 grid-cols-1 gap-6 mb-8">
                ...
                <div className='flex flex-col gap-6'>
                    ...
                    <p className='text-white font-neue-montreal text-[16px] font-normal'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s,</p>
                </div>
                ...
                <div className='flex flex-col gap-5'>
                    ...
                    <div className='relative'>
                        <button className='bg-[#7C1874] absolute right-2 top-1  transition-all w-fit duration-300 cursor-pointer hover:scale-[0.9] border border-[#7C1874] shadow-md shadow-[#7C1874] rounded-full text-[#F3F3F3] font-neue-montreal font-[400] text-[16px] hover:opacity-90 px-[18px] py-[8px] flex items-center gap-2'>
                            <Image src={img} width={28} height={28} alt='btn-img' />
                            <span>Submit</span>
                        </button>
                        <input type="text" placeholder="Enter your email here" className='bg-white px-6 py-4.5 outline-none pr-14 w-full rounded-full placeholder:text-[#404040] placeholder:text-[16px] font-normal text-[16px] placeholder:font-normal placeholder:font-neue-montreal font-neue-montreal' />
                    </div>
                </div>
            </div>
